...
tied_street_candidates = Tuple{Int64, Int64, Float16}[(2, d₁, r₁), (3, d₁, r₁), (4, d₁, r₁), (5, d₁, r₁)]
untied_street_candidates = Tuple{Int64, Int64, Float16}[(2, d₁, r₁), (3, d₁, r₁*2), (4, d₁, r₁*4), (5, d₁, r₁*8)]
...
function unvisited_test()
    return get_best_street(untied_street_candidates, unvisited, penalty) == Tuple{Int64, Int64, Float16}((5, 10, r₁*8))
end
...
function tie_breaker_test()
    return get_best_street(tied_street_candidates, unvisited, penalty) in tied_street_candidates
end
...
function visited_test()
    return get_best_street(untied_street_candidates, visited₅, penalty) == Tuple{Int64, Int64, Float16}((4, d₁, r₁*4))
end
...
"""
function visited_test_2()
    return get_best_street(untied_street_candidates, visited₅, penalty + 0.02) == Tuple{Int64, Int64, Float16}((5, d₁, r₁*8))
end


@test unvisited_test()
@test tie_breaker_test()
@test visited_test()
@test visited_test_2()